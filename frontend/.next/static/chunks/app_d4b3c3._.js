(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_d4b3c3._.js", {
...
const parseBankStatementText = async (text)=>{
    try {
...
const produceSummaryOpenAI = async (text)=>{
    try {
...
function FileSystemTree() {
    ...
    const handleNodeClick = async (nodeId)=>{
        ...
        if (node && node.hasChildren && node.children?.length === 0) {
            ...
            router.push(`/main/dashboard/analysis?bucketName=${encodeURIComponent('iarpus-bankstatement')}&filePath=${encodeURIComponent(node.id)}`);
        }
    };
...
//# sourceMappingURL=app_d4b3c3._.js.map