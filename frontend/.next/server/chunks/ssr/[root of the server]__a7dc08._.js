...
__turbopack_esm__({
    ...
    "processBankStatementOpenAI": (()=>processBankStatementOpenAI),
...
async function processBankStatementOpenAI(bucketName, filePath) {
    const response = await fetch("/api/files/analyze/openAI", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function createDirectory(bucketName, filePath, newFileName) {
...
const FolderCreationMenu = ({ open, setOpen })=>{
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$files$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createDirectory"])('iarpus-bankstatement', 'user1', directoryName.trim());
...
function FileSystemTree() {
    ...
    const handleNodeClick = async (nodeId)=>{
        ...
        if (node && node.hasChildren && node.children?.length === 0) {
            ...
            router.push(`/analysis?bucketName=${encodeURIComponent('iarpus-bankstatement')}&filePath=${encodeURIComponent(node.id)}`);
        }
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a7dc08._.js.map