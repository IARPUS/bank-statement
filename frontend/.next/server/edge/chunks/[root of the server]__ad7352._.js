(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__ad7352._.js", {
...
"[project]/app/api/upload/route.tsx [app-edge-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const runtime = 'edge'; // Use edge runtime for faster response handling
const config = {
    api: {
        bodyParser: false
    }
...
async function POST(req) {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(responseData, {
            status: response.status
        });
    } catch (error) {
...
"[project]/.next-internal/server/app/api/upload/route/actions.js [app-edge-rsc] (ecmascript)": (function(__turbopack_context__) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ad7352._.js.map