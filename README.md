An application which takes in pdf of bank statements and parses it using Optical Character Recognition (OCR) ML models and generative ML models to produce bank statement analysis for analysts to use.
